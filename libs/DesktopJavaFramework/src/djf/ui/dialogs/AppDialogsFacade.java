...
import static djf.AppTemplate.PATH_WEB_IMAGE;
...
public class AppDialogsFacade {
    ...
    public static void showExportDialog(AppTemplate app, String filePath) throws IOException {
        AppWebDialog dialog = new AppWebDialog(app);
//        PropertiesManager props = PropertiesManager.getPropertiesManager();
//        String filePath = props.getProperty(APP_EXPORT_PAGE);
    ...
    public static File showOpenImageDialog(Stage window, AppPropertyType openTitleProp) {
        FileChooser fc = new FileChooser();
        fc.setInitialDirectory(new File(PATH_WEB_IMAGE));
        PropertiesManager props = PropertiesManager.getPropertiesManager();
