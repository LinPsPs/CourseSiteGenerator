...
public class AppNodesBuilder {
    ...
    public ImageView buildImageView (Object nodeId,
        ...
        pane.add(iv, col, row);
        initNode(nodeId, iv, styleClass, enabled);
        return iv;
    }
    ...
    public DatePicker buildDatePicker (Object nodeId,
        ...
        pane.add(date, col, row);
        initNode(nodeId, date, styleClass, enabled);
        return date;
    }
    ...
    public TitledPane buildTitledPane (Object nodeId,
        ...
        String text = props.getProperty(propName);
        if (text != null) {
            languageSettings.addLabeledControlProperty(propName, titledPane.textProperty());
        }
