...
public abstract class AppTemplate extends Application {
    ...
    public static final String RECENT_SUBJECT = PATH_RECENT + "SubjectsInput.txt";
    public static final String RECENT_NUMBERS = PATH_RECENT + "NumbersInput.txt";
    ...
    public static final String PATH_STYLE = "./images/Style";
    public static final String PATH_IMAGE = "./images";
    public static final String PATH_WEB_IMAGE = "./original_web/images";
    public static final String PATH_WEBPAGE_CSS = "./webpage_css";
